...
from simulation import Simulation  # Make sure your class definitions are in simulation.py or adjust the import
from constants import *  # Assumed to include C, G, etc.
